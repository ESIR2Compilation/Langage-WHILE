 ...
 * </p>
 * <ul>
 *   <li>{@link org.xtext.langage_while.Def#getL <em>L</em>}</li>
 *   <li>{@link org.xtext.langage_while.Def#getIn <em>In</em>}</li>
 *   <li>{@link org.xtext.langage_while.Def#getZ <em>Z</em>}</li>
 *   <li>{@link org.xtext.langage_while.Def#getV <em>V</em>}</li>
 *   <li>{@link org.xtext.langage_while.Def#getS <em>S</em>}</li>
 *   <li>{@link org.xtext.langage_while.Def#getU <em>U</em>}</li>
...
public interface Def extends EObject
{
   ...
   * @see #setL(LCs)
   * @see org.xtext.langage_while.Langage_whilePackage#getDef_L()
  ...
  /**
   * Sets the value of the '{@link org.xtext.langage_while.Def#getL <em>L</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setZ(LCs)
   * @see org.xtext.langage_while.Langage_whilePackage#getDef_Z()
   * @model containment="true"
   * @generated
   */
  LCs getZ();
  ...
  /**
   * Sets the value of the '{@link org.xtext.langage_while.Def#getZ <em>Z</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setV(Commands)
   * @see org.xtext.langage_while.Langage_whilePackage#getDef_V()
   * @model containment="true"
   * @generated
   */
  Commands getV();
  ...
  /**
   * Sets the value of the '{@link org.xtext.langage_while.Def#getV <em>V</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setS(LCs)
   * @see org.xtext.langage_while.Langage_whilePackage#getDef_S()
   * @model containment="true"
   * @generated
   */
  LCs getS();
  ...
  /**
   * Sets the value of the '{@link org.xtext.langage_while.Def#getS <em>S</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setU(LCs)
   * @see org.xtext.langage_while.Langage_whilePackage#getDef_U()
   * @model containment="true"
   * @generated
   */
  LCs getU();
  ...
  /**
   * Sets the value of the '{@link org.xtext.langage_while.Def#getU <em>U</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->

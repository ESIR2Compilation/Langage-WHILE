 ...
 * <ul>
 *   <li>{@link org.xtext.langage_while.For#getEx <em>Ex</em>}</li>
 *   <li>{@link org.xtext.langage_while.For#getC <em>C</em>}</li>
 * </ul>
 * </p>
 *
...
public interface For extends EObject
{
   ...
   * @see #setEx(Expr)
   * @see org.xtext.langage_while.Langage_whilePackage#getFor_Ex()
  ...
  /**
   * Sets the value of the '{@link org.xtext.langage_while.For#getEx <em>Ex</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see #setC(Commands)
   * @see org.xtext.langage_while.Langage_whilePackage#getFor_C()
   * @model containment="true"
   * @generated
   */
  Commands getC();
  ...
  /**
   * Sets the value of the '{@link org.xtext.langage_while.For#getC <em>C</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
